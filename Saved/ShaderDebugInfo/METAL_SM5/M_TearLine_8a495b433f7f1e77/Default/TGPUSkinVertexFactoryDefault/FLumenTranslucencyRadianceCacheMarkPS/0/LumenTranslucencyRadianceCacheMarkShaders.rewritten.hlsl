...
cbuffer LumenTranslucencyRadianceCacheMarkPass {
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_SceneColorTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding4 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_SceneDepthTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding12 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_ScenePartialDepthTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding20 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_GBufferATexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding28 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_GBufferBTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding36 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_GBufferCTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding44 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_GBufferDTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding52 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_GBufferETexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding60 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_GBufferFTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding68 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_GBufferVelocityTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding76 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_ScreenSpaceAOTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding84 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_CustomDepthTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding92 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_CustomStencilTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding100 ;
	 uint    BindlessSampler_LumenTranslucencyRadianceCacheMarkPass_SceneTextures_PointClampSampler ;
	 float    LumenTranslucencyRadianceCacheMarkPass_Padding108 ;
	 uint    BindlessUAV_LumenTranslucencyRadianceCacheMarkPass_RWRadianceProbeIndirectionTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding116 ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding120 ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding124 ;
	 ...
	 float    LumenTranslucencyRadianceCacheMarkPass_Padding332 ;
	 uint    BindlessSRV_LumenTranslucencyRadianceCacheMarkPass_FurthestHZBTexture ;
	 uint    LumenTranslucencyRadianceCacheMarkPass_Padding340 ;
...
Texture2D  LumenTranslucencyRadianceCacheMarkPass_SceneTextures_SceneDepthTexture;
SamplerState  LumenTranslucencyRadianceCacheMarkPass_SceneTextures_PointClampSampler;
...
{
	return ConvertFromDeviceZ(Texture2DSampleLevel(LumenTranslucencyRadianceCacheMarkPass_SceneTextures_SceneDepthTexture, LumenTranslucencyRadianceCacheMarkPass_SceneTextures_PointClampSampler, ScreenUV, 0).r);
}
float CalcSceneDepth(uint2 PixelPos)
{
	float DeviceZ = LumenTranslucencyRadianceCacheMarkPass_SceneTextures_SceneDepthTexture.Load(int3(PixelPos, 0)).r;
	...
	, in bool bIsFrontFace : SV_IsFrontFace)
{
	...
	uint ClipmapIndex = GetRadianceProbeClipmapForMark(LWCToFloat(GetWorldPosition(MaterialParameters)), InterleavedGradientNoise(MaterialParameters.SvPosition.xy, View_StateFrameIndexMod8));
	if (IsValidRadianceCacheClipmapForMark(ClipmapIndex))
	{
		...
		{
			MarkPositionUsedInIndirectionTexture(LWCToFloat(GetWorldPosition(MaterialParameters)), ClipmapIndex);
		}
	}
}
